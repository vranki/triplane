...
int plane_manover[16] = {
    RED_MANOVER * PLANE_TURN_SPEED,  BLUE_MANOVER *PLANE_TURN_SPEED,
    GREEN_MANOVER *PLANE_TURN_SPEED, YELLOW_MANOVER *PLANE_TURN_SPEED,
    RED_MANOVER *PLANE_TURN_SPEED,   BLUE_MANOVER *PLANE_TURN_SPEED,
    GREEN_MANOVER *PLANE_TURN_SPEED, YELLOW_MANOVER *PLANE_TURN_SPEED,
    RED_MANOVER *PLANE_TURN_SPEED,   BLUE_MANOVER *PLANE_TURN_SPEED,
    GREEN_MANOVER *PLANE_TURN_SPEED, YELLOW_MANOVER *PLANE_TURN_SPEED,
    GREY_MANOVER *PLANE_TURN_SPEED,  GREY_MANOVER *PLANE_TURN_SPEED,
    GREY_MANOVER *PLANE_TURN_SPEED,  BLACK_MANOVER *PLANE_TURN_SPEED};

int plane_mass[16] = {200, 275, 200, 180, 200, 275, 200, 180,
                      200, 275, 200, 180, 200, 200, 200, 180};
...
int plane_bombs[16] = {4, 3, 5, 6, 4, 3, 5, 6, 4, 3, 5, 6, 4, 4, 4, 6};

int plane_gas[16] = {1600, 1800, 2047, 1400, 1600, 1800, 2047, 1400,
                     1600, 1800, 2047, 1400, 1800, 1800, 1800, 2047};

int plane_ammo[16] = {96, 96, 127, 80, 96, 96, 127, 80,
                      96, 96, 127, 80, 96, 96, 96,  127};
...
int t_plane_mass[16] = {200, 275, 200, 180, 200, 275, 200, 180,
                        200, 275, 200, 180, 200, 200, 200, 180};

int t_plane_bombs[16] = {4, 3, 5, 6, 4, 3, 5, 6, 4, 3, 5, 6, 4, 4, 4, 6};

int t_plane_gas[16] = {1600, 1800, 2047, 1400, 1600, 1800, 2047, 1400,
                       1600, 1800, 2047, 1400, 1800, 1800, 1800, 2047};

int t_plane_ammo[16] = {96, 96, 127, 80, 96, 96, 127, 80,
                        96, 96, 127, 80, 96, 96, 96,  127};
