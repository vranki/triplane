  ...
  for (l = 0; l < 4; l++) {
    ...
    if (!hangarmenu_active[l]) {
      ...
      maisema->blit(player_shown_x[l] - (player_x_8[l]) + x_muutos[l],
                    ...
                    x1_raja[l], y1_raja[l] + in_closing[l], x2_raja[l],
                    y2_raja[l]);

      for (l2 = 0; l2 < MAX_STRUCTURES; l2++) {
        if ((structures[l2][struct_state[l2]] != nullptr) &&
            (!leveldata.struct_hit[l2]))
          structures[l2][struct_state[l2]]->blit(
              (leveldata.struct_x[l2]) + player_shown_x[l] - (player_x_8[l]) +
                  x_muutos[l],
              (leveldata.struct_y[l2]) + player_shown_y[l] - (player_y_8[l]) +
                  y_muutos[l],
      ...
      for (l2 = 0; l2 < MAX_AA_GUNS; l2++) {
        ...
        if (kkbase_status[l2] != 2) {
          kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2]]->blit(
              kkbase_x[l2] + player_shown_x[l] - (player_x_8[l]) + x_muutos[l],
              kkbase_y[l2] + player_shown_y[l] - (player_y_8[l]) + y_muutos[l],
              x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        } else {
          kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2] >> 1]
              ->blit(kkbase_x[l2] + player_shown_x[l] - (player_x_8[l]) +
                         x_muutos[l],
                     kkbase_y[l2] + player_shown_y[l] - (player_y_8[l]) +
                         y_muutos[l],
                     x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        }
      }
      ...
      for (l2 = 0; l2 < MAX_INFANTRY; l2++) {
        ...
        case 0:
          if (infan_frame[l2] < 12)
            infantry_walking[infan_country[l2]][infan_direction[l2]]
                            [infan_frame[l2]]
                                ->blit(infan_x[l2] + player_shown_x[l] -
                                           (player_x_8[l]) + x_muutos[l],
                                       infan_y[l2] + player_shown_y[l] -
                                           (player_y_8[l]) + y_muutos[l],
                                       x1_raja[l], y1_raja[l], x2_raja[l],
                                       y2_raja[l]);
          else {
            if (infan_frame[l2] == 12)
              infantry_dropping[infan_country[l2]][infan_direction[l2]]->blit(
                  infan_x[l2] + player_shown_x[l] - (player_x_8[l]) +
                      x_muutos[l],
                  infan_y[l2] + player_shown_y[l] - (player_y_8[l]) +
                      y_muutos[l],
                  x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
            else
              infantry_after_drop[infan_country[l2]][infan_direction[l2]]->blit(
                  infan_x[l2] + player_shown_x[l] - (player_x_8[l]) +
                      x_muutos[l],
                  infan_y[l2] + player_shown_y[l] - (player_y_8[l]) +
                      y_muutos[l],
        ...
        case 1:
          ...
          infantry_aiming[infan_country[l2]][infan_direction[l2]]
                         [infan_frame[l2]]
                             ->blit(infan_x[l2] + player_shown_x[l] -
                                        (player_x_8[l]) + x_muutos[l],
                                    infan_y[l2] + player_shown_y[l] -
        ...
        case 2:
          ...
          infantry_shooting[infan_country[l2]][infan_direction[l2]]
                           [infan_frame[l2]]
                               ->blit(infan_x[l2] + player_shown_x[l] -
                                          (player_x_8[l]) + x_muutos[l],
                                      infan_y[l2] + player_shown_y[l] -
        ...
        case 3:
          ...
          infantry_dying[infan_country[l2]][infan_direction[l2]]
                        [infan_frame[l2] >> 1]
                            ->blit(infan_x[l2] + player_shown_x[l] -
                                       (player_x_8[l]) + x_muutos[l],
                                   infan_y[l2] + player_shown_y[l] -
        ...
        case 4:
          ...
          infantry_wavedeath[infan_country[l2]][infan_direction[l2]]
                            [infan_frame[l2] >> 1]
                                ->blit(infan_x[l2] + player_shown_x[l] -
                                           (player_x_8[l]) + x_muutos[l],
                                       infan_y[l2] + player_shown_y[l] -
        ...
        case 5:
          ...
          infantry_bdying[infan_country[l2]][infan_direction[l2]]
                         [infan_frame[l2] >> 1]
                             ->blit(infan_x[l2] + player_shown_x[l] -
                                        (player_x_8[l]) + x_muutos[l],
                                    infan_y[l2] + player_shown_y[l] -
      ...
      for (l2 = 0; l2 < 4; l2++) {
        ...
        case 1:
          mekan_running[mekan_frame[l2]][mekan_direction[l2]]->blit(
              mekan_x[l2] + player_shown_x[l] - (player_x_8[l]) + x_muutos[l],
              mekan_y[l2] + player_shown_y[l] - (player_y_8[l]) + y_muutos[l],
              x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          break;

        case 2:
          mekan_pushing[0][mekan_frame[l2]][mekan_direction[l2]]->blit(
              mekan_x[l2] + player_shown_x[l] - (player_x_8[l]) + x_muutos[l],
              mekan_y[l2] + player_shown_y[l] - (player_y_8[l]) + y_muutos[l],
              x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          break;
        ...
        case 3:
          mekan_pushing[1][mekan_frame[l2]][mekan_direction[l2]]->blit(
              mekan_x[l2] + player_shown_x[l] - (player_x_8[l]) + x_muutos[l],
              mekan_y[l2] + player_shown_y[l] - (player_y_8[l]) + y_muutos[l],
              x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          break;
      ...
      for (l2 = 0; l2 < MAX_BOMBS; l2++)
        if (bomb_x[l2])
          bomb[(bomb_angle[l2] >> 8) / 6]->blit(
              (bomb_x[l2] >> 8) + player_shown_x[l] - (player_x_8[l]) - (4) +
                  x_muutos[l],
              (bomb_y[l2] >> 8) + player_shown_y[l] - (player_y_8[l]) - (4) +
                  y_muutos[l],
      ...
      for (l2 = 0; l2 < 16; l2++)
        if (!in_closing[l2] && player_exists[l2] && !plane_coming[l2]) {
          ...
          if (!computer_active[l] &&
              (tempx > 156 || tempx < 0 || tempy > 88 || tempy < 0)) {
            ...
            radar[player_tsides[l2]][temp]->blit(
                x1_raja[l], y_muutos[l] + 44 + tempy, x1_raja[l],
                y1_raja[l] + in_closing[l], x2_raja[l], y2_raja[l]);
            radar[player_tsides[l2]][temp]->blit(
                x_muutos[l] + 78 + tempx, y1_raja[l], x1_raja[l],
                y1_raja[l] + in_closing[l], x2_raja[l], y2_raja[l]);
          }

          planes[l2][(player_angle[l2] >> 8) / 6][player_rolling[l2]]
                [player_upsidedown[l2]]
                    ->blit((player_x_8[l2]) + player_shown_x[l] -
                               (player_x_8[l]) - 10 + x_muutos[l],
                           (player_y_8[l2]) + player_shown_y[l] -
                               (player_y_8[l]) - 10 + y_muutos[l],
                           x1_raja[l], y1_raja[l] + in_closing[l], x2_raja[l],
                           y2_raja[l]);
        } else {
          if (in_closing[l2] <= 12 && player_exists[l2] && !plane_coming[l2])
            plane_crash[(in_closing[l2] >> 1) - 1]->blit(
                (player_x_8[l2]) + player_shown_x[l] - (player_x_8[l]) - 10 +
                    x_muutos[l],
                (player_y_8[l2]) + player_shown_y[l] - (player_y_8[l]) - 10 +
                    y_muutos[l],
                x1_raja[l], y1_raja[l] + in_closing[l], x2_raja[l], y2_raja[l]);
        }
          ...
          if (shots_flying_x[l2])
            putpix((shots_flying_x[l2] >> 8) + player_shown_x[l] -
                   ...
                   (shots_flying_y[l2] >> 8) + player_shown_y[l] -
                       (player_y_8[l]) + y_muutos[l],
                   SHOTS_COLOR, x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        }
          ...
          if (itgun_shot_x[l2])
            putpix((itgun_shot_x[l2] >> 8) + player_shown_x[l] -
                   ...
                   (itgun_shot_y[l2] >> 8) + player_shown_y[l] -
                       (player_y_8[l]) + y_muutos[l],
                   ITGUN_SHOT_COLOR, x1_raja[l], y1_raja[l], x2_raja[l],
                   y2_raja[l]);
        }
      ...
      for (l2 = 0; l2 < MAX_FLYING_OBJECTS; l2++) {
        if (fobjects[l2].x) {
          ...
          case FOBJECTS_SMOKE:
            smoke[fobjects[l2].phase]->blit(
                (fobjects[l2].x >> 8) + player_shown_x[l] - (player_x_8[l]) -
                    (fobjects[l2].width >> 1) + x_muutos[l],
                (fobjects[l2].y >> 8) + player_shown_y[l] - (player_y_8[l]) -
                    (fobjects[l2].height >> 1) + y_muutos[l],
                x1_raja[l], y1_raja[l] + in_closing[l], x2_raja[l], y2_raja[l]);
            break;

          case FOBJECTS_SSMOKE:
            ssmoke[fobjects[l2].phase]->blit(
                (fobjects[l2].x >> 8) + player_shown_x[l] - (player_x_8[l]) -
                    (fobjects[l2].width >> 1) + x_muutos[l],
                (fobjects[l2].y >> 8) + player_shown_y[l] - (player_y_8[l]) -
                    (fobjects[l2].height >> 1) + y_muutos[l],
          ...
          case FOBJECTS_ITEXPLOSION:
            itexplosion[fobjects[l2].phase]->blit(
                (fobjects[l2].x >> 8) + player_shown_x[l] - (player_x_8[l]) -
                    (fobjects[l2].width >> 1) + x_muutos[l],
                (fobjects[l2].y >> 8) + player_shown_y[l] - (player_y_8[l]) -
                    (fobjects[l2].height >> 1) + y_muutos[l],
          ...
          case FOBJECTS_EXPLOX:
            if (fobjects[l2].phase < 0)
              break;
            explox[fobjects[l2].subtype][fobjects[l2].phase]->blit(
                (fobjects[l2].x >> 8) + player_shown_x[l] - (player_x_8[l]) -
                    (fobjects[l2].width >> 1) + x_muutos[l],
                (fobjects[l2].y >> 8) + player_shown_y[l] - (player_y_8[l]) -
                    (fobjects[l2].height >> 1) + y_muutos[l],
    ...
    gas_icon->blit(3 + x_muutos[l] + (player_gas[l] >> 8) * 3,
                   92 + (l / 2) * 98 -
                       ((player_gas[l] - ((player_gas[l] >> 8) << 8))) / 32,
                   0, 92 + (l / 2) * 98, 319, 99 + (l / 2) * 98);

    if (computer_active[l]) {
      closed->blit(2 + x_muutos[l], 2 + y_muutos[l] + in_closing[l] - 88,
                   x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
    } else {
      if (in_closing[l]) {

        hangarmenu->blit(x1_raja[l], y1_raja[l] + in_closing[l] - 88,
                         x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        flags[l][7]->blit(x1_raja[l] + 14, y1_raja[l] + in_closing[l] - 88 + 67,
                          x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);

        switch (hangarmenu_position[l]) {
        case 0:
          hangaractive->blit(x1_raja[l] + 35,
                             y1_raja[l] + 74 -
                                 (46 * hangarmenu_bombs[l]) / plane_bombs[l] +
                                 in_closing[l] - 88,
                             x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          hangarinactive->blit(x1_raja[l] + 69,
                               y1_raja[l] + 74 -
                                   (46 * hangarmenu_ammo[l]) / plane_ammo[l] +
                                   in_closing[l] - 88,
                               x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          hangarinactive->blit(x1_raja[l] + 103,
                               y1_raja[l] + 74 -
                                   (46 * hangarmenu_gas[l]) / plane_gas[l] +
                                   in_closing[l] - 88,
                               x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          break;

        case 1:
          hangarinactive->blit(x1_raja[l] + 35,
                               y1_raja[l] + 74 -
                                   (46 * hangarmenu_bombs[l]) / plane_bombs[l] +
                                   in_closing[l] - 88,
                               x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          hangaractive->blit(x1_raja[l] + 69,
                             y1_raja[l] + 74 -
                                 (46 * hangarmenu_ammo[l]) / plane_ammo[l] +
                                 in_closing[l] - 88,
                             x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        ...
        case 2:
          ...
          hangarinactive->blit(x1_raja[l] + 69,
                               y1_raja[l] + 74 -
                                   ...
                                   in_closing[l] - 88,
                               x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
          hangaractive->blit(x1_raja[l] + 103,
                             y1_raja[l] + 74 -
                                 (46 * hangarmenu_gas[l]) / plane_gas[l] +
                                 in_closing[l] - 88,
                             x1_raja[l], y1_raja[l], x2_raja[l], y2_raja[l]);
        ...
        hangarmenu->blit(x1_raja[l], y1_raja[l], x1_raja[l], y1_raja[l],
                         x2_raja[l], y2_raja[l]);
...
void solo_terrain_to_screen() {
  ...
  if (((player_x_8[l]) - player_shown_x[l] + 320) > NUMBER_OF_SCENES * 160)
    player_shown_x[l] -=
        NUMBER_OF_SCENES * 160 - ((player_x_8[l]) - player_shown_x[l] + 320);
  ...
  gas_icon->blit(1 + (player_gas[l] >> 8) * 3,
                 2 - (((player_gas[l] - ((player_gas[l] >> 8) << 8))) >> 5), 0,
                 2, 319, 9);
  ...
  if (config.flags)
    for (l2 = 0; l2 < MAX_FLAGS; l2++) {
      if (flags_x[l2]) {
        ...
        flags[flags_owner[l2]][flags_frame[l2]]->blit(
            flags_x[l2] + player_shown_x[l] - (player_x_8[l]), flags_y[l2]);
      }
    }
  ...
  for (l2 = 0; l2 < MAX_AA_GUNS; l2++) {
    ...
    if (kkbase_status[l2] != 2)
      kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2]]->blit(
          kkbase_x[l2] + player_shown_x[l] - (player_x_8[l]), kkbase_y[l2]);
    else
      kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2] >> 1]->blit(
          kkbase_x[l2] + player_shown_x[l] - (player_x_8[l]), kkbase_y[l2]);
  }
  ...
  if (hangarmenu_active[l]) {
    ...
    switch (hangarmenu_position[l]) {
    case 0:
      hangaractive->blit(35,
                         15 + 74 - (46 * hangarmenu_bombs[l]) / plane_bombs[l]);
      hangarinactive->blit(69,
                           15 + 74 - (46 * hangarmenu_ammo[l]) / plane_ammo[l]);
      hangarinactive->blit(103,
                           15 + 74 - (46 * hangarmenu_gas[l]) / plane_gas[l]);
      break;

    case 1:
      hangarinactive->blit(35, 15 + 74 -
                                   (46 * hangarmenu_bombs[l]) / plane_bombs[l]);
      hangaractive->blit(69,
                         15 + 74 - (46 * hangarmenu_ammo[l]) / plane_ammo[l]);
      hangarinactive->blit(103,
                           15 + 74 - (46 * hangarmenu_gas[l]) / plane_gas[l]);
      break;
  ...
  for (l2 = 0; l2 < MAX_INFANTRY; l2++) {
    ...
    case 0:
      if (infan_frame[l2] < 12)
        ...
        if (infan_frame[l2] == 12)
          infantry_dropping[infan_country[l2]][infan_direction[l2]]->blit(
              infan_x[l2] + player_shown_x[l] - (player_x_8[l]), infan_y[l2]);
        else
          infantry_after_drop[infan_country[l2]][infan_direction[l2]]->blit(
              infan_x[l2] + player_shown_x[l] - (player_x_8[l]), infan_y[l2]);
      }
    ...
    case 1:
      infantry_aiming[infan_country[l2]][infan_direction[l2]][infan_frame[l2]]
          ->blit(infan_x[l2] + player_shown_x[l] - (player_x_8[l]),
                 infan_y[l2]);
      break;

    case 2:
      infantry_shooting[infan_country[l2]][infan_direction[l2]][infan_frame[l2]]
          ->blit(infan_x[l2] + player_shown_x[l] - (player_x_8[l]),
                 infan_y[l2]);
      break;

    case 3:
      infantry_dying[infan_country[l2]][infan_direction[l2]][infan_frame[l2] >>
                                                             1]
          ->blit(infan_x[l2] + player_shown_x[l] - (player_x_8[l]),
                 infan_y[l2]);
      break;
    ...
    case 5:
      infantry_bdying[infan_country[l2]][infan_direction[l2]][infan_frame[l2] >>
                                                              1]
          ->blit(infan_x[l2] + player_shown_x[l] - (player_x_8[l]),
                 infan_y[l2]);
      break;
  ...
  for (l2 = 0; l2 < 4; l2++) {
    ...
    case 1:
      mekan_running[mekan_frame[l2]][mekan_direction[l2]]->blit(
          mekan_x[l2] + player_shown_x[l] - (player_x_8[l]), mekan_y[l2]);
      break;
  ...
  for (l2 = 0; l2 < 16; l2++)
    if (!in_closing[l2] && player_exists[l2] && !plane_coming[l2]) {
      ...
      planes[l2][(player_angle[l2] >> 8) /
                 6][player_rolling[l2]][player_upsidedown[l2]]
          ->blit((player_x_8[l2]) + player_shown_x[l] - (player_x_8[l]) - 10,
                 (player_y_8[l2]) - 10);
...
#ifdef COMPUDEBUG
  for (l = 0; l < 4; l++) {
    frost->printf(5, 10 + 12 * l,
                  "Plane %d: Mission:%d Phase:%d Target:%d Up:%d Down:%d "
                  "Power:%d Speed:%d Angle:%d Dst:%d A:%d",
                  l, current_mission[l], mission_phase[l], mission_target[l],
                  controls_up[l], controls_down[l], controls_power[l],
                  player_speed[l], player_angle[l] >> 8, distances[l],
                  angles[l]);
  }
#endif
}
...
void kangas_terrain_to_screen(int left_x) {
  ...
  maisema->blit(left_x, -PROJECTOR_Y_ADJUSTMENT, PROJECTOR_X1, PROJECTOR_Y1,
  ...
  for (l2 = 0; l2 < MAX_STRUCTURES; l2++) {
    ...
    if ((structures[l2][struct_state[l2]] != nullptr) &&
        (!leveldata.struct_hit[l2])) {
      structures[l2][0]->blit((leveldata.struct_x[l2]) + left_x,
                              leveldata.struct_y[l2] - PROJECTOR_Y_ADJUSTMENT,
                              PROJECTOR_X1, PROJECTOR_Y1, PROJECTOR_X2,
                              PROJECTOR_Y2);
    }
  }
  ...
  for (l2 = 0; l2 < MAX_FLAGS; l2++) {
    if (flags_x[l2]) {
      ...
      flags[flags_owner[l2]][flags_frame[l2]]->blit(
          flags_x[l2] + left_x, flags_y[l2] - PROJECTOR_Y_ADJUSTMENT,
          PROJECTOR_X1, PROJECTOR_Y1, PROJECTOR_X2, PROJECTOR_Y2);
    }
  }
  ...
  for (l2 = 0; l2 < MAX_AA_GUNS; l2++) {
    ...
    if (kkbase_status[l2] != 2)
      kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2]]->blit(
          kkbase_x[l2] + left_x, kkbase_y[l2] - PROJECTOR_Y_ADJUSTMENT,
          PROJECTOR_X1, PROJECTOR_Y1, PROJECTOR_X2, PROJECTOR_Y2);
    else
      kkbase[kkbase_type[l2]][kkbase_status[l2]][kkbase_frame[l2] >> 1]->blit(
          kkbase_x[l2] + left_x, kkbase_y[l2] - PROJECTOR_Y_ADJUSTMENT,
...
void vesa_terrain_to_screen() {
  ...
  for (l = 0; l < 4; l++) {
    ...
    ovi[hangar_door_frame[l]]->blit(hangar_x[l] + 27 - templevel * screen_width,
                                    hangar_y[l] + 3 + templevel * 196 - 4, 0, 0,
  ...
  if (config.flags)
    for (l = 0; l < MAX_FLAGS; l++) {
      if (flags_x[l]) {
        ...
        flags[flags_owner[l]][flags_frame[l]]->blit(
            flags_x[l] - templevel * screen_width,
            flags_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
            screen_height_less);
      }
    }
  ...
  for (l = 0; l < MAX_AA_GUNS; l++) {
    ...
    if (kkbase_status[l] != 2)
      kkbase[kkbase_type[l]][kkbase_status[l]][kkbase_frame[l]]->blit(
          kkbase_x[l] - templevel * screen_width,
          kkbase_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
          screen_height_less);
    else
      kkbase[kkbase_type[l]][kkbase_status[l]][kkbase_frame[l] >> 1]->blit(
          kkbase_x[l] - templevel * screen_width,
          kkbase_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
          screen_height_less);
    ...
    if (kkbase_x[l] - templevel * screen_width + 26 > screen_width) {
      if (kkbase_status[l] != 2)
        kkbase[kkbase_type[l]][kkbase_status[l]][kkbase_frame[l]]->blit(
            kkbase_x[l] - templevel * screen_width - screen_width,
            kkbase_y[l] + (templevel + 1) * 196 - 4, 0, 0, screen_width_less,
            screen_height_less);
      else
        kkbase[kkbase_type[l]][kkbase_status[l]][kkbase_frame[l] >> 1]->blit(
            kkbase_x[l] - templevel * screen_width - screen_width,
  ...
  for (l = 0; l < 4; l++)
    if (hangarmenu_active[l]) {
      ...
      switch (hangarmenu_position[l]) {
      case 0:
        hangaractive->blit(200 * l + 20 + 35,
                           74 - (46 * hangarmenu_bombs[l]) / plane_bombs[l]);
        hangarinactive->blit(200 * l + 20 + 69,
                             74 - (46 * hangarmenu_ammo[l]) / plane_ammo[l]);
        hangarinactive->blit(200 * l + 20 + 103,
                             74 - (46 * hangarmenu_gas[l]) / plane_gas[l]);
        break;

      case 1:
        hangarinactive->blit(200 * l + 20 + 35,
                             74 - (46 * hangarmenu_bombs[l]) / plane_bombs[l]);
        hangaractive->blit(200 * l + 20 + 69,
                           74 - (46 * hangarmenu_ammo[l]) / plane_ammo[l]);
        hangarinactive->blit(200 * l + 20 + 103,
                             74 - (46 * hangarmenu_gas[l]) / plane_gas[l]);
        break;
      ...
      case 2:
        ...
        hangarinactive->blit(200 * l + 20 + 69,
                             74 - (46 * hangarmenu_ammo[l]) / plane_ammo[l]);
        hangaractive->blit(200 * l + 20 + 103,
                           74 - (46 * hangarmenu_gas[l]) / plane_gas[l]);
        break;
      }
    }
  ...
  for (l = 0; l < MAX_INFANTRY; l++) {
    ...
    case 0:
      if (infan_frame[l] < 12)
        infantry_walking[infan_country[l]][infan_direction[l]][infan_frame[l]]
            ->blit(infan_x[l] - templevel * screen_width,
                   infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
                   screen_height_less);
      else {
        if (infan_frame[l] == 12)
          infantry_dropping[infan_country[l]][infan_direction[l]]->blit(
              infan_x[l] - templevel * screen_width,
              infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
              screen_height_less);
        else
          infantry_after_drop[infan_country[l]][infan_direction[l]]->blit(
              infan_x[l] - templevel * screen_width,
              infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
              screen_height_less);
      }
    ...
    case 1:
      infantry_aiming[infan_country[l]][infan_direction[l]][infan_frame[l]]
          ->blit(infan_x[l] - templevel * screen_width,
                 infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
                 screen_height_less);
      break;
    ...
    case 2:
      infantry_shooting[infan_country[l]][infan_direction[l]][infan_frame[l]]
          ->blit(infan_x[l] - templevel * screen_width,
                 infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
                 screen_height_less);
      break;
    ...
    case 3:
      infantry_dying[infan_country[l]][infan_direction[l]][infan_frame[l] >> 1]
          ->blit(infan_x[l] - templevel * screen_width,
                 infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
                 screen_height_less);
      break;
    ...
    case 4:
      infantry_wavedeath[infan_country[l]][infan_direction[l]]
                        [infan_frame[l] >> 1]
                            ->blit(infan_x[l] - templevel * screen_width,
                                   infan_y[l] + templevel * 196 - 4, 0, 0,
                                   screen_width_less, screen_height_less);
      break;

    case 5:
      infantry_bdying[infan_country[l]][infan_direction[l]][infan_frame[l] >> 1]
          ->blit(infan_x[l] - templevel * screen_width,
                 infan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
                 screen_height_less);
      break;
  ...
  for (l = 0; l < 4; l++) {
    ...
    case 1:
      mekan_running[mekan_frame[l]][mekan_direction[l]]->blit(
          mekan_x[l] - templevel * screen_width,
          mekan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
          screen_height_less);
      break;

    case 2:
      mekan_pushing[0][mekan_frame[l]][mekan_direction[l]]->blit(
          mekan_x[l] - templevel * screen_width,
          mekan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
          screen_height_less);
      break;
    ...
    case 3:
      mekan_pushing[1][mekan_frame[l]][mekan_direction[l]]->blit(
          mekan_x[l] - templevel * screen_width,
          mekan_y[l] + templevel * 196 - 4, 0, 0, screen_width_less,
          screen_height_less);
      break;
  ...
  for (l2 = 0; l2 < 16; l2++) {
    ...
    if (!in_closing[l2] && player_exists[l2] && !plane_coming[l2]) {
      ...
      planes[l2][(player_angle[l2] >> 8) / 6][player_rolling[l2]]
            [player_upsidedown[l2]]
                ->blit(((player_x_8[l2]) - 10) - templevel * screen_width,
      ...
      if (in_closing[l2] <= 12 && player_exists[l2] && !plane_coming[l2])
        plane_crash[(in_closing[l2] >> 1) - 1]->blit(
            ((player_x_8[l2]) - 10) - templevel * screen_width,
            ((player_y_8[l2]) - 10) + templevel * 196 - 4, 0, templevel * 196,
            screen_width_less, screen_height_less);
    }
  }
        ...
        planes[l2][(player_angle[l2] >> 8) / 6][player_rolling[l2]]
              [player_upsidedown[l2]]
                  ->blit(((player_x_8[l2]) - 10) - templevel * screen_width -
                         ...
                         (templevel + 1) * 196, screen_width_less,
                         screen_height_less);
      else {
        if (in_closing[l2] <= 12 && player_exists[l2] && !plane_coming[l2])
          plane_crash[(in_closing[l2] >> 1) - 1]->blit(
              ((player_x_8[l2]) - 10) -
                  (((player_x_8[l2]) - 10) / screen_width) * screen_width -
                  screen_width,
              ((player_y_8[l2]) - 10) + (templevel + 1) * 196 - 4, 0,
    ...
    for (l2 = 0; l2 < MAX_SHOTS; l2++) {
      if (shots_flying_x[l2])
        putpix((shots_flying_x[l2] >> 8) -
               ...
               SHOTS_COLOR, 0, 0, screen_width_less, screen_height_less);
    }
  ...
  for (l2 = 0; l2 < MAX_BOMBS; l2++) {
    if (bomb_x[l2]) {
      ...
      bomb[(bomb_angle[l2] >> 8) / 6]->blit(
          ((bomb_x[l2] >> 8) - (4)) - templevel * screen_width,
          ((bomb_y[l2] >> 8) - (4)) + templevel * 196 - 4, 0, templevel * 196,
          screen_width_less, screen_height_less);
    }
  }
  ...
  for (l2 = 0; l2 < MAX_FLYING_OBJECTS; l2++) {
    if (fobjects[l2].x) {
      templevel =
          (((fobjects[l2].x >> 8) - (fobjects[l2].width >> 1)) / screen_width);
      switch (fobjects[l2].type) {
      case FOBJECTS_SMOKE:
        smoke[fobjects[l2].phase]->blit(
            ((fobjects[l2].x >> 8) - (fobjects[l2].width >> 1)) -
                templevel * screen_width,
            ((fobjects[l2].y >> 8) - (fobjects[l2].height >> 1)) +
                templevel * 196 - 4,
            0, templevel * 196, screen_width_less, screen_height_less);
        break;
...
void vesa_icons(int l) {
  int l2;
  boards[l]->blit(l * 160, screen_height - 12, 0, 0, screen_width_less,
                  screen_height_less);
  for (l2 = 5; l2 >= 0; l2--) {
    if ((player_bombs[l] - 1) >= l2)
      break;

    bomb_icon->blit(l * 160 + 57 + l2 * 6, screen_height - 11, 0, 0,
                    screen_width_less, screen_height_less);
  }
  ...
  for (l2 = 7; l2 >= 0; l2--) {
    ...
    big_ammo_icon->blit(l * 160 + 101 + l2 * 4, screen_height - 11, 0, 0,
                        screen_width_less, screen_height_less);
  }
  ...
  for (l2 = 15; l2 >= 0; l2--) {
    ...
    small_ammo_icon->blit(l * 160 + 101 + l2 * 2, screen_height - 5, 0, 0,
                          screen_width_less, screen_height_less);
  }
  ...
  for (l2 = 7; l2 >= 0; l2--) {
    ...
    gas_icon->blit(l * 160 + 1 + l2 * 3, screen_height - 10, 0, 0,
                   screen_width_less, screen_height_less);
  }

  gas_icon->blit(l * 160 + 1 + (player_gas[l] >> 8) * 3,
                 screen_height - 10 -
                     ((player_gas[l] - ((player_gas[l] >> 8) << 8))) / 32,
...
void vesa_solo_icons(int l) {
  ...
  boards[l]->blit(0, screen_height - 12, 0, 0, screen_width_less,
                  screen_height_less);
  board2->blit(158, screen_height - 12, 0, 0, screen_width_less,
               screen_height_less);
  ...
  for (l2 = 5; l2 >= 0; l2--) {
    ...
    bomb_icon->blit(57 + l2 * 6, screen_height - 11, 0, 0, screen_width_less,
                    screen_height_less);
  }
  ...
  for (l2 = 7; l2 >= 0; l2--) {
    ...
    big_ammo_icon->blit(101 + l2 * 4, screen_height - 11, 0, 0,
                        screen_width_less, screen_height_less);
  }
  ...
  for (l2 = 15; l2 >= 0; l2--) {
    ...
    small_ammo_icon->blit(101 + l2 * 2, screen_height - 5, 0, 0,
                          screen_width_less, screen_height_less);
  }
  ...
  for (l2 = 7; l2 >= 0; l2--) {
    ...
    gas_icon->blit(1 + l2 * 3, screen_height - 10, 0, 0, screen_width_less,
                   screen_height_less);
  }
