...
extern std::unique_ptr<Bitmap> explox[4][EXPLOX_FRAMES];
extern std::unique_ptr<Bitmap> maisema;
extern std::unique_ptr<Bitmap> bites[NUMBER_OF_BITES];
extern std::unique_ptr<Bitmap> menu1;
extern std::unique_ptr<Bitmap> structures[MAX_STRUCTURES][2];
extern std::unique_ptr<Bitmap> temp_bitti;
extern std::unique_ptr<Bitmap> cursor;
extern std::unique_ptr<Bitmap> kkbase[2][3][7];
extern std::unique_ptr<Bitmap> infantry_walking[4][2][12];
extern std::unique_ptr<Bitmap> infantry_dying[4][2][7];
extern std::unique_ptr<Bitmap> infantry_aiming[4][2][6];
extern std::unique_ptr<Bitmap> infantry_wavedeath[4][2][10];
extern std::unique_ptr<Bitmap> infantry_shooting[4][2][6];
extern std::unique_ptr<Bitmap> infantry_bdying[4][2][10];
extern std::unique_ptr<Bitmap> infantry_dropping[4][2];
extern std::unique_ptr<Bitmap> infantry_after_drop[4][2];
extern std::unique_ptr<Bitmap> itexplosion[ITEXPLOSION_FRAMES];
extern std::unique_ptr<Bitmap> flames[6];
extern std::unique_ptr<Bitmap> status_icons[2][2];
...
extern std::unique_ptr<Bitmap> radar[4][8];
...
extern std::unique_ptr<Bitmap> mekan_running[14][2];
extern std::unique_ptr<Bitmap> mekan_pushing[2][14][2];
